...
MPI:    make clean
	make
	mpirun -np 8 ./main  //you can change 8 to any number of processes you need to try as long as you have 				    
			       enough logical cores. Try "lscpu" in the terminal and look for CPU(s): (cores)
